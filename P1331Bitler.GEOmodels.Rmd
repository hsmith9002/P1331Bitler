...
set.seed(2110)
## log likelihood
cnuh.perm <- getKM.permuted.LRT.v2(cnuh, nPerm = 10, cnuh.outcome, cnuh.time)
...
set.seed(2110)
## log likelihood
lindgren.perm <- getKM.permuted.LRT.v2(lindgren, nPerm = 10, Lindgren.outcome, Lindgren.time)
...
set.seed(2110)
cit.perm <- getKM.permuted.LRT.v2(cit.2, nPerm = 10, cit.pheno.2$RFS.event, cit.pheno.2$RFS.delay)
## log likelihood
...
set.seed(2110)
Sboner.perm <- getKM.permuted.LRT.v2(Sboner.2, nPerm = 10, pd.Sboner$event, pd.Sboner$time)
## log likelihood
...
set.seed(2110)
Bos.perm <- getKM.permuted.LRT.v2(Sboner.2, nPerm = 10, pd.Sboner$event, pd.Sboner$time)
## log likelihood
...
set.seed(2110)
Duke.perm <- getKM.permuted.LRT.v2(Duke2, nPerm = 10, as.numeric(forAnalysis[,"event"]), as.numeric(forAnalysis[,"time"]))
## log likelihood
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
png(file = "/Users/harry/Documents/CIDA/Projects/P1331Bitler/graphics/KM_curves_Manuscript.png", height = 15, width = 15, res = 400, units = "in")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
multiplot(cnuh.dist, cnuh.dist, lindgren.dist, lindgren.distw, cit.dist, cit.distw, Sboner.dist, Sboner.distw, Bos.dist, Bos.distw, Duke.dist, Duke.distw, cols = 4)
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
#save(cnuh.pp, lindgren.pp, cit.pp, Sboner.pp, Bos.pp, Duke.pp, file = "/Users/harry/Documents/CIDA/Projects/P1331Bitler/dataProcessed/persResults.RData")
